...
class FileBehaviors2:
    ...
    recurse: FileBehaviorsRecurse2 = field(
        default=FileBehaviorsRecurse2.SYMLINKS_AND_DIRECTORIES,
        metadata={
            "type": "Attribute",
        },
    )
    recurse_direction: FileBehaviorsRecurseDirection2 = field(
        default=FileBehaviorsRecurseDirection2.NONE,
        metadata={
            "type": "Attribute",
        },
    )
    recurse_file_system: FileBehaviorsRecurseFileSystem2 = field(
        default=FileBehaviorsRecurseFileSystem2.ALL,
        metadata={
            "type": "Attribute",
        },
    )
