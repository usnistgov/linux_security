...
@dataclass
class PortinfoTest(TestType):
    """The port info test is used to check the properties of a component of a
    FreeBSD system.
    ...
    portinfo_object and the optional state element specifies the data to
    check.
    """
